...
void main(void)
{
	static unsigned char i,pause,song;
	...
	put_str(NTADR_A(2,2),"FAMITRACKER DRIVER EXAMPLE");
	put_str(NTADR_A(2,4),"A      TO PLAY MUSIC");
	put_str(NTADR_A(2,5),"B      TO STOP MUSIC");
	put_str(NTADR_A(2,7),"START  TO PAUSE MUSIC");
	put_str(NTADR_A(2,8),"SELECT TO CHANGE SONG");
	put_str(NTADR_A(2,10),"D-PAD  TO PLAY SFX");
